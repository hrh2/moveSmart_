...
export default function Notification() {
  return (
      <div className=' h-auto  md:w-1/3 sm:w-1/3 w-10/12 bg-blue-700 bg-opacity-60 fixed md:left-[5.5%] sm:left-[8.5%] left-[15.5%] top-4 p-2 rounded-md text-white z-20 grid grid-flow-row gap-2'>
